...
import com.info.denemeecommerceapp2.data.order.getOrderStatus
import com.info.denemeecommerceapp2.databinding.OrderItemBinding
        ...
        fun bind(order:Order){
            binding.apply {
                ...
                val resources = itemView.resources
                    ...
                    else -> ColorDrawable(resources.getColor(R.color.g_red))
